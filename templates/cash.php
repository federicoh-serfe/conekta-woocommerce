...
<div id="conektaIframeCashContainer" style="height: 70rem; width: 100%;"></div>
<script>
    let order_cash_button = document.getElementById('place_order');
    if(order_cash_button)
        order_cash_button.style.display = "none";
    
    window.ConektaCheckoutComponents.Integration({
        targetIFrame: "#conektaIframeCashContainer",
        ...
        onCreateTokenSucceeded: function (token) {console.log("ACA")},
        onCreateTokenError: function (error) {console.log("ACA")},
        onFinalizePayment: function(event){console.log("ACA")},
        onErrorPayment: function(event) {console.log("ACA")}
    })
</script>